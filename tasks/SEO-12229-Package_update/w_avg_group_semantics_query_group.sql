DROP VIEW IF EXISTS `ozontest.Client_6.w_avg_group_semantics_query_group`;

CREATE VIEW `ozontest.Client_6.w_avg_group_semantics_query_group` AS
-- адаптер исходных данных, и защита от деления на 0
WITH adapter AS (
    SELECT project_id, project_name, group_id, group_name, search_engine, date,
      queries_count, frequency2,
      top3_count, top5_count, top10_count, top100_count,
      frequency2_top10_count, potential_traffic_count
    FROM `ozontest.Client_6.v_semantics_query_group`
